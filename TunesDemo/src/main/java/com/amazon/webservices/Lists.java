...
public class Lists {
    ...
    protected java.util.List<com.amazon.webservices.List> list;
     ...
     * {@link com.amazon.webservices.List }
     * 
     * 
     */
    public java.util.List<com.amazon.webservices.List> getList() {
        if (list == null) {
            list = new ArrayList<com.amazon.webservices.List>();
        }
        return this.list;
    }
