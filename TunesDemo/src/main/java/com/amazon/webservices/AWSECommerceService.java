 ...
 * 
 */
@WebServiceClient(name = "AWSECommerceService", targetNamespace = "http://webservices.amazon.com/AWSECommerceService/2011-04-01", wsdlLocation = "http://ecs.amazonaws.com/AWSECommerceService/2011-04-01/AWSECommerceService.wsdl")
public class AWSECommerceService
    extends Service
{

    private final static URL AWSECOMMERCESERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(com.amazon.webservices.AWSECommerceService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.amazon.webservices.AWSECommerceService.class.getResource(".");
            url = new URL(baseUrl, "http://ecs.amazonaws.com/AWSECommerceService/2011-04-01/AWSECommerceService.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://ecs.amazonaws.com/AWSECommerceService/2011-04-01/AWSECommerceService.wsdl', retrying as a local file");
