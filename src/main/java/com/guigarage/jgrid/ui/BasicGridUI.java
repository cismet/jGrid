...
public class BasicGridUI extends GridUI {
    ...
    protected int getPreferredHeightForWidth(final int width) {
        ...
        int cellsInRow = 0;
        final int widthOneCell = grid.getHorizonztalMargin()
        ...
        final int heightOneCell = grid.getVerticalMargin() + grid.getVerticalMargin()
    ...
    private void updateCellBounds() {
        ...
        for (int i = 0; i < grid.getModel().getSize(); i++) {
            ...
            final Rectangle r = new Rectangle(x, y, grid.getFixedCellDimension(),
                    grid.getFixedCellDimension());
    ...
    protected void paintCell(final Graphics g,
        ...
        final Component rendererComponent = grid.getCellRenderer(index)
    ...
    public int[] getCellsIntersectedBy(final Rectangle rect) {
        final Set<Integer> intersectSet = new TreeSet<Integer>();
