...
public class iPhotoDemo extends JFrame {
	...
	public iPhotoDemo() {
		...
		for (int i = 0; i < 10; i++) {
			model.addElement(new BufferedImageIPhotoObject(new File("src/test/java/de/loganmobile/grid/iphoto/coast/")));
			model.addElement(new BufferedImageIPhotoObject(new File("src/test/java/de/loganmobile/grid/iphoto/dogs")));
			model.addElement(new BufferedImageIPhotoObject(new File("src/test/java/de/loganmobile/grid/iphoto/emotions")));
			model.addElement(new BufferedImageIPhotoObject(new File("src/test/java/de/loganmobile/grid/iphoto/flowers")));
			model.addElement(new BufferedImageIPhotoObject(new File("src/test/java/de/loganmobile/grid/iphoto/landscape")));
		}
